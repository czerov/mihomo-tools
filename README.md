...
```bash
rm -rf /etc/mihomo-tools && git clone [https://github.com/KyleYu2024/mihomo-tools.git](https://github.com/KyleYu2024/mihomo-tools.git) /etc/mihomo-tools && bash /etc/mihomo-tools/install.sh
```
